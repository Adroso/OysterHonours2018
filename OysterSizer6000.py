...
def read_image(image_to_process):
    return ski.imread(image_to_process, as_grey=True)

def pre_process_image(image):
    #TODO Split image
    pass

def cnn_edge_detect(image):
    #Specify Kernal
...
def edge_detector_6000(filtered_result, filtered_results_2):
    ...
    filteres_2_transposed = np.array(
        filtered_results_2).transpose().tolist()  # untransposing to make it look good again.
